...
int main(void) {
    ...
    write_sound(SINE_WAVE, s, 269.292 * 2, fs * 2, fs, true, false);
    write_sound(SINE_WAVE, s, 339.286 * 2, fs * 2, fs, true, false);
    write_sound(SINE_WAVE, s, 403.482 * 2, fs * 2, fs, true, true);

    write_sound(SINE_WAVE, s, 285.305 * 2, fs * 2, fs, true, false);
    write_sound(SINE_WAVE, s, 359.461 * 2, fs * 2, fs, true, false);
    write_sound(SINE_WAVE, s, 452.893 * 2, fs * 2, fs, true, true);
